...
<table width=100%>\
    ...
    <col width=32%>\
    <tr>\
        <td> <text class='rect BlackBG Title'>Measured Temp</text> </td>\
        <td> <text id='T_Meas' class='rect BlackBG Units'>xxx.x F &nbsp;</text> </td>\
...
<table width=100%>\
    ...
    <col width=16%>\
    <tr>\
        <td><text class='rect BlackBG Title'>Target Temp</text> </td>\
        <td><input type='number' id='T_Target' class='rect BlackBG Units'></input> </td>\
        <td></td>\
        <td><text id='T_TargetAdd' class='rect RedBG'> + </text> </td>\
        <td><text id='T_TargetSub' class='rect BlueBG'> - </text> </td>\
    </tr>\
    <tr>\
        <td><text class='rect BlackBG Title'>Hysteresis</text> </td>\
        <td><input type='number' id='T_Hyst' class='rect BlackBG Units'></input> </td>\
        <td></td>\
...
<table width=100%>\
    ...
    <col width=16%>\
    <tr>\
        <td><text class='rect BlackBG Title'>Manual Timer</text></td>\
        <td><text id='t_Manual' class='rect BlackBG Units'>x.xx</text></td>\
    ...
    <tr>\
        <td><text class='rect BlackBG Title'>Dip Timer</text> </td>\
        <td><text id='t_Dip' class='rect BlackBG Units'>0:00</text> </td>\
        <td></td>\
        <td></td>\
        <td></td>\
    </tr>\
    <tr>\
        <td><text class='rect BlackBG Title'>Recover Timer</text> </td>\
        <td><text id='t_Recover' class='rect BlackBG Units'>0:00</text> </td>\
        <td></td>\
        <td></td>\
        <td></td>\
    </tr>\
...
<table width=100%>\
    ...
    <col width=16%>\
    <tr>\
        <td> <text class='rect BlackBG Title'>Flame Off Cal</text> </td>\
        <td><input type='number' id='Cnt_FlameOff' class='rect BlackBG Units'></input></td>\
        <td></td>\
        <td></td>\
        <td></td>\
\
    ...
    <tr>\
        <td> <text class='rect BlackBG Title'>Flame On Cal</text> </td>\
        <td><input type='number' id='Cnt_FlameOn' class='rect BlackBG Units'></input></td>\
    </tr>\
    <tr>\
        <td><br><text class='rect BlackBG Title'>Temperature 2</text></td>\
        <td><br><text id='T_Filt_2' class='rect BlackBG Units'>xxx.x F &nbsp;</text></td>\
        <td></td>\
        <td></td>\
        <td></td>\
    </tr>\
    <tr>\
        <td> <text class='rect BlackBG Title'>Temperature 3</text> </td>\
        <td> <text id='T_Filt_3' class='rect BlackBG Units'>xxx.x F &nbsp;</text> </td>\
        <td></td>\
        <td></td>\
        <td></td>\
    </tr>\
...
\
        if (Cnt_Min > 0) {\
            document.getElementById(str_element).className = 'rect BlackBG Units';\
        } else if (Cnt_Min > -1) {\
